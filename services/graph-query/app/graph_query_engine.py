...
class GraphQueryEngine:
    ...
    def get_dependency_graph(
        ...
        if namespace:
            ...
            #
            # Examples (namespace = 'pilot-flowfish'):
            # - pilot-flowfish → pilot-flowfish: OK (both in namespace)
            # - pilot-flowfish → external: OK (one in namespace)
            # - external → pilot-flowfish: OK (one in namespace)
