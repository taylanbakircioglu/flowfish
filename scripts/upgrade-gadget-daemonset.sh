...
#   ./upgrade-gadget-daemonset.sh pilot-flowfish
#   ./upgrade-gadget-daemonset.sh pilot-flowfish v0.48.0
#   ./upgrade-gadget-daemonset.sh pilot-flowfish --rollback
#
#   # Using Harbor registry
#   ./upgrade-gadget-daemonset.sh pilot-flowfish v0.48.0 harbor.example.com/flowfish
#   ./upgrade-gadget-daemonset.sh pilot-flowfish --rollback harbor.example.com/flowfish
#
...
show_usage() {
    ...
    echo "  $0 pilot-flowfish                    # Upgrade to v0.48.0"
    echo "  $0 pilot-flowfish v0.48.0            # Upgrade to v0.48.0"
    echo "  $0 pilot-flowfish --rollback         # Rollback to v0.46.0"
    echo ""
    echo "  # Using Harbor registry"
    echo "  $0 pilot-flowfish v0.48.0 harbor.example.com/flowfish"
    echo "  $0 pilot-flowfish --rollback harbor.example.com/flowfish"
    echo ""
    echo "  # Using environment variable"
    echo "  export GADGET_REGISTRY=\"harbor.example.com/flowfish\""
    echo "  $0 pilot-flowfish v0.48.0"
    echo ""
}
