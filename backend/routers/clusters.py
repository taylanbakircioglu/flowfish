...
#   ./setup-flowfish-remote.sh pilot-flowfish
#
#   # Using internal Harbor registry with persistent storage:
#   ./setup-flowfish-remote.sh pilot-flowfish harbor.example.com/flowfish/inspektor-gadget v0.48.0 standard
#
#   # Using only storage class (with default registry and version):
#   ./setup-flowfish-remote.sh pilot-flowfish "" "" gp2
#
# Arguments:
...
if [ -z "$NAMESPACE" ]; then
    ...
    echo -e "  Example: pilot-flowfish, prod-flowfish"
